    ...
    <>
      <div className="flex w-full">
        <div className="w-full sm:w-[80vw] md:w-[80vw] lg:w-[80vw]  xl:w-[50vw] 2xl:w-[50vw]">
          <div className="text-4xl font-bold mb-5" style={{ color: "var(--doc-title-color)" }}>Input</div>
          <div
      ...
      <Input placeholder="disabled" disabled/>
          ...
          <div id="props" className="scroll-mt-10">
            <div className="mb-5" style={{ color: "var(--doc-text-secondary)" }}>Input</div>
          </div>
          ...
          <div id="materialInput" className="scroll-mt-10">
            <div className="mb-5 mt-5" style={{ color: "var(--doc-text-secondary)" }}>MaterialInput</div>
          </div>
        ...
        <div className="pl-30 ml-5 pt-30 fixed right-0 hidden sm:hidden md:hidden lg:block lg:w-80 xl:block xl:w-80">
          ...
          <div className="text-sm mb-3 font-bold" style={{ color: "var(--doc-text-primary)" }}>Input</div>
